...
import 'package:rfid_reader_sdk/src/models/reader_config.dart';
import 'package:rfid_reader_sdk/src/models/reader_device.dart';
import 'package:rfid_reader_sdk/src/rfid_reader_sdk_method_channel.dart';
...
abstract class ZebraRfidReaderSdkPlatform extends PlatformInterface {
  ...
  Future<void> findMultipleTag(List<String> tags) async {
    throw UnimplementedError('findMultipleTag() has not been implemented.');
  }
